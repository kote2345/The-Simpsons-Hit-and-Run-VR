...
pushd "%~dp0.."
cl /nologo /EHsc /std:c++17 /I"%~1\Include" tools\test-hdr-resolve.cpp /Fo:build\pcvr\test-hdr-resolve.obj /Fe:build\pcvr\test-hdr-resolve.exe /link /LIBPATH:"%~1\Lib" vulkan-1.lib
if errorlevel 1 exit /b 1
build\pcvr\test-hdr-resolve.exe
